...
const Dock = ({windowsState, setWindowsState}) => {
  return (
    <footer className='dock'> 
        ...
        <div onClick={()=>{window.open("https://calendar.google.comthat","_blank")}} 
        ...
        <div onClick={()=>{window.open("mailto:kunalraikwar12367@gmail.com","_blank")}}
        className="icon mail"><img src="/doc-icons/mail.svg" alt="" /></div>

        <div onClick={()=>{window.open("https://github.com/KunalRaikwar02","_blank")}} 
